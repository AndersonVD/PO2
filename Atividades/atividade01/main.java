...
// Frequencia chamada = new Frequencia(disciplina_mat, LocalDate.now(), true,
// professor1);
...
// aluno.getCurso().getFases().get(Fases.getNumero() - 1).getDisciplinas()) {
...
// public Frequencia(Disciplina disciplina, LocalDate data, Boolean isPresente,
// Professor professor) {
